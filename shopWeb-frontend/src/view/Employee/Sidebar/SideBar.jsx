    ...
    <aside className="">
      ...
      <div className="top">
        <Link to="/employee/dashboard" style={{ textDecoration: "none" }}>
          <span className="logo">WEB NHÂN VIÊN</span>
        </Link>
      </div>
      <hr />
      <div className="bottom">
        <ul>
          ...
          <Link to="/employee/products" style={{ textDecoration: "none" }}>
            <li>
              <LocalGroceryStoreOutlinedIcon className="icon" />
              <span>Sản phẩm</span>
            </li>
          </Link>
          <Link to="/employee/cart" style={{ textDecoration: "none" }}>
            <li>
            <LocalGroceryStoreOutlinedIcon className="icon" />
              <span>Giỏ hàng</span>
            </li>
          </Link>
          <Link to="/employee/orders" style={{ textDecoration: "none" }}>
            <li>
